			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="current" title="${message(code: 'user.current.label', default: 'Current')}" />
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: userInstance, field: "addr1")}</td>
						...
						<td><g:formatBoolean boolean="${userInstance.current}" /></td>
